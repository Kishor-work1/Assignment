        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 sm:mb-8 space-y-4 sm:space-y-0">
          <div className="flex items-center space-x-3 sm:space-x-4">
            <div className="relative">
              {/* Refined header icon background */}
              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    statusConfig.badgeColor.replace("bg-gradient-to-r", "").split(" ").slice(0, 4).join(" "),
                  )}
                ></div>
                  ...
                  <div className="flex items-start justify-between mb-3 sm:mb-4">
                    <div className="flex items-center space-x-3 sm:space-x-4 flex-1">
                      ...
                      <div className="relative flex-shrink-0">
                        ...
                        >
                          <div className="w-2.5 h-2.5 sm:w-3 sm:h-3">{statusConfig.icon}</div>
                        </div>
                      </div>
                    ...
                    {[
                      ...
                      >
                        <div className="flex items-center space-x-2 sm:space-x-3">
                          <div className="p-1.5 sm:p-2 bg-white rounded-lg shadow-sm flex-shrink-0">{item.icon}</div>
