...
import { Pill, Plus, Clock, Check, X, User, Calendar, TrendingUp, Activity, FileText, Shield } from "lucide-react"
                ...
                <CardContent className="p-6 space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="medName" className="text-sm font-medium text-gray-700">Medication Name *</Label>
                      <Input
                        id="medName"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="prescribedBy" className="text-sm font-medium text-gray-700">Prescribed By</Label>
                      <Input
                        id="prescribedBy"
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-col lg:flex-row items-start justify-between mb-6 space-y-4 lg:space-y-0">
                    ...
                    <div className="flex items-center space-x-6">
                      <div className="text-center">
                        ...
                        <div className={cn(
                          "text-2xl font-bold",
                          adherenceRate >= 80 ? "text-emerald-600" : adherenceRate >= 60 ? "text-amber-600" : "text-red-600"
                        )}>
                          {adherenceRate}%
                        </div>
                      </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {Array.from(new Set(medication.schedule.map((s) => s.date))).map((date) => {
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center space-x-4">
                              <div className="w-10 h-10 bg-white rounded-lg shadow-sm flex items-center justify-center font-semibold text-gray-700 border border-gray-200">
                            ...
                            <div className="text-right">
                              <span className="font-semibold text-gray-900">{dayTaken}/{dayTotal}</span>
            ...
            <CardContent className="text-center py-16 px-8">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-6">Add the first prescription to begin medication tracking and monitoring.</p>
                  <Button 
                    onClick={() => setShowAddForm(true)} 
